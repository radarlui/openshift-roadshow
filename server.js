...
app.get('/api/workshops/roadshow', function (req, res) {
   ...
   res.send(JSON.stringify({"id":"roadshow","modules":["environment","explore","docker","scaling","routes","logging","permissions","java","databases", "further-resources" ],"name":"Roadshow"
}));
})
